...
const tokenomicsData = [
  ...
  { allocation: "Liquidity Reserve", percentage: 15, description: "For exchange listings and to ensure sufficient trading liquidity across multiple platforms.", color: "rgba(255, 138, 101, 0.9)" },
