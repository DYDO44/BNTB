...
const ProfitCalculator = ({ currentPrice = 0.0004, currentStage = 4 }) => {
  // Price constants (in USDT)
  const PRICES = {
    FIRST_STAGE: 0.000001,  // First stage starting price
              ...
              <div className="calculator-content">
                ...
                <div className="results-section">
                  <div className="result-item">
                    ...
                    <span className="result-value">{formatNumber(tokenAmount)} MAGA</span>
                  </div>
                  <div className="result-item">
